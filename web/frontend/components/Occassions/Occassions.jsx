...
export const AddOccassionPopupContext = React.createContext();

const Occassions = () => {
    const [activeAddOccassionsPopup, setActiveAddOccassionsPopup] = useState(false)
    return (
        <AddOccassionPopupContext.Provider
            value={{
                activeAddOccassionsPopup,
                setActiveAddOccassionsPopup
            }}
        >
            <div className='Occassions-page-os'>
                ...
                {activeAddOccassionsPopup && <AddOccassionsPopup />}
            </div>
        </AddOccassionPopupContext.Provider>
    )
}
